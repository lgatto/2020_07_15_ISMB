...
*> in_mem <- readMSData(f, mode = "inMemory")
*> on_disk <- readMSData(f, mode = "onDisk")
> on_disk
...
### Acknowledgements: MSnbase contributors and users

## Thank you for your attention

### Want to learn more:

- **Slides**: https://lgatto.github.io/2020_07_15_ISMB_online/
- **Pre-print**:
